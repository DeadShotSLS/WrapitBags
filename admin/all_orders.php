...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT user_info.*, orders.* FROM user_info INNER JOIN orders ON user_info.user_id=orders.user_id ";
            ...
            <!-- footer -->
            <footer class="footer" style="text-align: center"> © 2020 Wrapit Bags</a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
