...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update categories set cat_title ='$_POST[cat_title]' where cat_id='$_GET[cat_upd]'";
	mysqli_query($db, $mql);
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post' >
                                    <div class="form-body">
                                        <?php $ssql ="select * from categories where cat_id='$_GET[cat_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="cat_title" value="<?php echo $row['cat_title'];  ?>" class="form-control" placeholder="Category Name">
                                                   </div>
                                            </div>
                                            <!--/span-->
